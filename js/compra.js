...
function procesarCompra() {
    ...
    if (compra.obtenerProductosLocalStorage().length === 0) {
    ...
    else if (cliente.value === '' || dni.value === '' || direccion.value === '' || contacto.value === '' || correo.value === '') {
        Swal.fire({
            type: 'error',
            title: 'Oops...',
        ...
        (function () {
            emailjs.init("user_1CrSgaCTaqwfiEYCiU7HQ");
        })();
            ...
            emailjs.sendForm(service_id, template_id, myform[0])
                .then(() => {
                    cargandoGif.style.display = 'none';
                        document.querySelector('#loader').appendChild(enviado);
